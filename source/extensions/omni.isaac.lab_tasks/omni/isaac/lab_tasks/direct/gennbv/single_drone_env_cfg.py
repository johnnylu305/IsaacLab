...
CAMERA_FOLDER = 'camera_image_envsize20_gennbv_house3k'
...
# define SCANRL environment
@configclass
class GENNBVEnvCfg(DirectRLEnvCfg):

    # data
    data_root = os.path.join(os.path.abspath(os.sep), "home", "Dataset", "houes3k_env20")
    ...
    total_img = 100 # timeout
    num_observations = total_img * 5
    goal = 0.99 # coverage ratio
