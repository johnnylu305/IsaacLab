...
from omni.isaac.lab.sim.converters import MeshConverterRescaleMAD3D, MeshConverterCfg
...
def main():
    ...
    #meshes_path = sorted(glob.glob(os.path.join(args_cli.input, '**', '*.obj'), recursive=True))
    import pdb; pdb.set_trace()
